...
import com.aamend.texata.graph.CommunityDetection
...
/**
  ...
  */
class LouvainDetection(minProgress: Int = 1, progressCounter: Int = 1) extends CommunityDetection with Serializable {

  var communityGraph: Option[Graph[VertexId, VertexId]] = None: Option[Graph[Long, Long]]

  override def run[VD: ClassTag](graph: Graph[VD, Long]): VertexRDD[Long] = {
